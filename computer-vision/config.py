...
FREEZE_BACKBONE_EPOCHS = 0  # Set to 0 for standard training, 3 when fine-tuning on AffectNet
BACKBONE_LR = 1e-4  # Lower learning rate for backbone after unfreezing
CLASSIFIER_LR = 2e-4  # Higher learning rate for classifier head after unfreezing

# Model Configuration
NUM_CLASSES = 7
CLASS_NAMES = ['angry', 'disgust', 'fear', 'happy', 'neutral', 'sad', 'surprise']
PRETRAINED = False  # Set to False to use FER-trained weights instead of ImageNet
...
AFFECTNET_DATA_DIR = os.path.join(PROJECT_ROOT, "data", "RAF-DB")
